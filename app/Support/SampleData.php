    ...
    public static function tours(): array
    {
        return array_map([self::class, 'enrichPackagePrice'], [
            ...
            [
                ...
                'badge' => 'Mới',
                'featured' => false,
                'styles' => ['culture-history', 'beach', 'balanced', 'honeymoon'],
                'quote' => ['text' => 'Ubud rất thơ, Tanah Lot lúc hoàng hôn đẹp không tưởng. Cảm ơn ViTravel đã sắp xếp chỉn chu.', 'author' => 'Chị Lan Phương'],
                'places' => ['Denpasar', 'Ubud', 'Tegalalang', 'Tanah Lot', 'Seminyak', 'Uluwatu'],
                'start' => 'Denpasar (DPS)',
                'end' => 'Denpasar (DPS)',
                ...
                'highlights' => [
                    'Ruộng bậc thang Tegalalang & làng nghệ nhân Ubud',
                    'Hoàng hôn đền Tanah Lot trên đá biển',
                    'Lớp nấu ăn Bali với nguyên liệu chợ địa phương',
                    '2 đêm resort biển Seminyak + đền Uluwatu & Kecak',
                ],
                'itinerary' => [
                    ['day' => 1, 'title' => 'Denpasar — Ubud chào đón', 'meals' => 'Tối', 'transport' => ['plane', 'car'], 'overnight' => 'Ubud', 'content' => 'Đón sân bay DPS, về Ubud nhận villa. Chiều dạo trung tâm, tối thưởng thức ẩm thực Bali.'],
                    ['day' => 2, 'title' => 'Ubud — Tegalalang & nghệ thuật', 'meals' => 'Sáng; Trưa', 'transport' => ['car'], 'overnight' => 'Ubud', 'content' => 'Ngắm ruộng bậc thang, thăm làng bạc Celuk và xưởng batik; chiều tự do spa hoặc yoga.'],
                    ['day' => 3, 'title' => 'Ubud — Lớp nấu ăn & đền thiêng', 'meals' => 'Sáng; Trưa', 'transport' => ['car'], 'overnight' => 'Ubud', 'content' => 'Mua nguyên liệu ở chợ, học nấu món Bali; chiều thăm Tirta Empul hoặc Goa Gajah.'],
                    ['day' => 4, 'title' => 'Tanah Lot — Seminyak', 'meals' => 'Sáng', 'transport' => ['car'], 'overnight' => 'Seminyak', 'content' => 'Hoàng hôn Tanah Lot, về resort biển Seminyak nghỉ dưỡng.'],
                    ['day' => 5, 'title' => 'Seminyak — Ngày biển', 'meals' => 'Sáng', 'transport' => ['walking'], 'overnight' => 'Seminyak', 'content' => 'Tự do tắm biển, hồ bơi; chiều dạo Beach Walk hoặc massage truyền thống.'],
                    ['day' => 6, 'title' => 'Uluwatu & Kecak', 'meals' => 'Sáng; Tối', 'transport' => ['car'], 'overnight' => 'Seminyak', 'content' => 'Chiều đền Uluwatu trên vách đá, xem múa Kecak hoàng hôn; tối hải sản Jimbaran.'],
                    ['day' => 7, 'title' => 'Tạm biệt Bali', 'meals' => 'Sáng', 'transport' => ['car', 'plane'], 'overnight' => null, 'content' => 'Tuỳ giờ bay: mua sắm hoặc spa ngắn, xe đưa ra sân bay DPS.'],
                ],
                'inclusions' => [
                    'Villa/resort 4* (3 đêm Ubud + 2 đêm Seminyak + 1 đêm tuỳ lịch)',
                    'Xe riêng đời mới & tài xế tiếng Anh cơ bản',
                    'Hướng dẫn viên địa phương các ngày tham quan',
                    'Vé đền, lớp nấu ăn, show Kecak theo chương trình',
                    'Bữa ăn ghi trong lịch trình',
                ],
                'exclusions' => [
                    'Vé máy bay quốc tế đến/đi Bali',
                    'Visa on arrival / e-VOA (nếu áp dụng)',
                    'Đồ uống, tip, chi phí cá nhân',
                    'Bảo hiểm du lịch',
                ],
                'notes' => [
                    'Nên mặc lịch sự khi vào đền (có thể thuê sarong tại chỗ).',
                    'Mùa khô đẹp nhất: tháng 4 – tháng 10.',
                ],
                'faqs' => [
                    ['q' => 'Tour Bali 7 ngày có phù hợp trăng mật không?', 'a' => 'Có — lịch trình kết hợp Ubud lãng mạn và resort biển; có thể nâng cấp villa riêng với phụ phí.'],
                    ['q' => 'Có cần visa Indonesia không?', 'a' => 'Công dân nhiều nước được e-VOA hoặc miễn thị thực ngắn hạn — chúng tôi hướng dẫn trước khi đi.'],
                ],
                'galleryCount' => 5,
                'en' => [
                    ...
                    'end' => 'Denpasar (DPS)',
                    'places' => ['Denpasar', 'Ubud', 'Tegalalang', 'Tanah Lot', 'Seminyak', 'Uluwatu'],
                    'quote' => ['text' => 'Ubud was poetic and Tanah Lot at sunset unforgettable. Thank you ViTravel for a seamless trip.', 'author' => 'Lan Phuong'],
                    ...
                    'highlights' => [
                        'Tegalalang rice terraces & Ubud artisan villages',
                        'Sunset at Tanah Lot sea temple',
                        'Hands-on Balinese cooking class',
                        'Two nights at Seminyak beach + Uluwatu & Kecak',
                    ],
                    'itinerary' => [
                        ['day' => 1, 'title' => 'Denpasar — Welcome to Ubud', 'meals' => 'Dinner', 'transport' => ['plane', 'car'], 'overnight' => 'Ubud', 'content' => 'Airport pickup, check in at your Ubud villa. Evening stroll and Balinese dinner.'],
                        ['day' => 2, 'title' => 'Ubud — Tegalalang & crafts', 'meals' => 'Breakfast; Lunch', 'transport' => ['car'], 'overnight' => 'Ubud', 'content' => 'Rice terraces, Celuk silver village and batik workshop; free afternoon for spa or yoga.'],
                        ['day' => 3, 'title' => 'Ubud — Cooking & temples', 'meals' => 'Breakfast; Lunch', 'transport' => ['car'], 'overnight' => 'Ubud', 'content' => 'Market shopping and cooking class; afternoon at Tirta Empul or Goa Gajah.'],
                        ['day' => 4, 'title' => 'Tanah Lot — Seminyak', 'meals' => 'Breakfast', 'transport' => ['car'], 'overnight' => 'Seminyak', 'content' => 'Tanah Lot sunset, then check in at your Seminyak beach resort.'],
                        ['day' => 5, 'title' => 'Seminyak — Beach day', 'meals' => 'Breakfast', 'transport' => ['walking'], 'overnight' => 'Seminyak', 'content' => 'Free day for beach, pool and optional massage.'],
                        ['day' => 6, 'title' => 'Uluwatu & Kecak', 'meals' => 'Breakfast; Dinner', 'transport' => ['car'], 'overnight' => 'Seminyak', 'content' => 'Cliff-top Uluwatu temple, Kecak dance at sunset, seafood dinner in Jimbaran.'],
                        ['day' => 7, 'title' => 'Farewell Bali', 'meals' => 'Breakfast', 'transport' => ['car', 'plane'], 'overnight' => null, 'content' => 'Transfer to DPS airport according to your flight time.'],
                    ],
                    'inclusions' => [
                        '4* villa/resort (Ubud + Seminyak nights as per itinerary)',
                        'Private modern car & driver',
                        'Local guide on sightseeing days',
                        'Temple tickets, cooking class and Kecak show as listed',
                        'Meals indicated in the itinerary',
                    ],
                    'exclusions' => [
                        'International flights to/from Bali',
                        'Visa on arrival / e-VOA if required',
                        'Drinks, tips and personal expenses',
                        'Travel insurance',
                    ],
                    'notes' => [
                        'Dress modestly at temples (sarong rental available on site).',
                        'Best dry season: April–October.',
                    ],
                    'faqs' => [
                        ['q' => 'Is this Bali tour good for honeymoons?', 'a' => 'Yes — Ubud romance plus beach resort nights; private villa upgrades are available.'],
                        ['q' => 'Do I need a visa for Indonesia?', 'a' => 'Many nationalities use e-VOA or short-stay visa exemption — we guide you before departure.'],
                    ],
                ],
            ],
            [
                ...
                'badge' => 'Bán chạy',
                'featured' => false,
                'styles' => ['culture-history', 'beach', 'balanced', 'long-duration'],
                'quote' => ['text' => 'Chiang Mai dịu dàng, Bangkok sôi động, biển Phuket trong xanh — đúng một Thái Lan trọn vẹn.', 'author' => 'Anh Đức Minh'],
                'places' => ['Chiang Mai', 'Ayutthaya', 'Bangkok', 'Phuket', 'Phi Phi'],
                ...
                'highlights' => [
                    'Đoàn xe đạp/xe tuk-tuk quanh cổ thành & đền Doi Suthep',
                    'Chợ đêm Chiang Mai & lớp nấu ăn Thái',
                    'Grand Palace, Wat Pho & du thuyền Chao Phraya',
                    'Cano / speedboat vịnh Phuket – quần đảo Phi Phi',
                ],
                'itinerary' => [
                    ['day' => 1, 'title' => 'Chiang Mai — Xin chào xứ Lanna', 'meals' => 'Tối', 'transport' => ['plane', 'car'], 'overnight' => 'Chiang Mai', 'content' => 'Đón sân bay CNX, nhận khách sạn. Chiều dạo cổ thành, tối chợ đêm.'],
                    ['day' => 2, 'title' => 'Chiang Mai — Đền & đồi', 'meals' => 'Sáng; Trưa', 'transport' => ['car'], 'overnight' => 'Chiang Mai', 'content' => 'Wat Phra Singh, Wat Chedi Luang; chiều lên Doi Suthep ngắm toàn cảnh.'],
                    ['day' => 3, 'title' => 'Chiang Mai — Ẩm thực & thủ công', 'meals' => 'Sáng; Trưa', 'transport' => ['car'], 'overnight' => 'Chiang Mai', 'content' => 'Lớp nấu ăn Thái; chiều làng thủ công hoặc trekking nhẹ tuỳ chọn.'],
                    ['day' => 4, 'title' => 'Bay về Bangkok', 'meals' => 'Sáng', 'transport' => ['plane', 'car'], 'overnight' => 'Bangkok', 'content' => 'Bay nội địa CNX–BKK, chiều tự do Siam / rooftop.'],
                    ['day' => 5, 'title' => 'Bangkok — Cung điện & chùa vàng', 'meals' => 'Sáng; Trưa', 'transport' => ['car', 'boat'], 'overnight' => 'Bangkok', 'content' => 'Grand Palace, Wat Pho; chiều thuyền dài trên kênh khlong.'],
                    ['day' => 6, 'title' => 'Ayutthaya trong ngày', 'meals' => 'Sáng; Trưa', 'transport' => ['car'], 'overnight' => 'Bangkok', 'content' => 'Di sản Ayutthaya, chiều về Bangkok — tối tự do Iconsiam hoặc Asiatique.'],
                    ['day' => 7, 'title' => 'Bay vào Phuket', 'meals' => 'Sáng', 'transport' => ['plane', 'car'], 'overnight' => 'Phuket', 'content' => 'Bay BKK–HKT, nhận resort biển; chiều tắm biển Patong/Kata.'],
                    ['day' => 8, 'title' => 'Phi Phi / vịnh Phang Nga', 'meals' => 'Sáng; Trưa', 'transport' => ['boat'], 'overnight' => 'Phuket', 'content' => 'Tour đảo trong ngày (Phi Phi hoặc Phang Nga tuỳ mùa), lặn ngắm san hô.'],
                    ['day' => 9, 'title' => 'Phuket — Ngày nghỉ', 'meals' => 'Sáng', 'transport' => ['walking'], 'overnight' => 'Phuket', 'content' => 'Tự do resort, spa hoặc Old Town Phuket về đêm.'],
                    ['day' => 10, 'title' => 'Tạm biệt Thái Lan', 'meals' => 'Sáng', 'transport' => ['car', 'plane'], 'overnight' => null, 'content' => 'Xe đưa sân bay HKT theo giờ bay quốc tế.'],
                ],
                'inclusions' => [
                    'Khách sạn 4* (Chiang Mai + Bangkok + Phuket)',
                    'Vé máy bay nội địa CNX–BKK và BKK–HKT',
                    'Xe riêng / guide các ngày tham quan',
                    'Tour đảo 1 ngày phía Nam',
                    'Bữa ăn theo chương trình',
                ],
                'exclusions' => [
                    'Vé máy bay quốc tế đến Chiang Mai / về từ Phuket',
                    'Visa Thái (nếu cần)',
                    'Đồ uống, tip, chi phí cá nhân',
                    'Bảo hiểm du lịch',
                ],
                'notes' => [
                    ...
                    'Mùa biển phía Nam đẹp: tháng 11 – tháng 4.',
                ],
                'faqs' => [
                    ['q' => 'Có thể đổi điểm biển Phuket sang Krabi không?', 'a' => 'Được — báo khi đặt tour, chuyên gia sẽ điều chỉnh vé và khách sạn trong 24 giờ.'],
                    ['q' => 'Trẻ em tham gia tour đảo có an toàn không?', 'a' => 'Có, chọn tour phù hợp độ tuổi; áo phao và hướng dẫn viên trên tàu luôn có.'],
                ],
                'galleryCount' => 5,
                'en' => [
                    ...
                    'end' => 'Phuket (HKT)',
                    'places' => ['Chiang Mai', 'Ayutthaya', 'Bangkok', 'Phuket', 'Phi Phi'],
                    'quote' => ['text' => 'Gentle Chiang Mai, buzzing Bangkok and crystal Phuket — a complete Thailand in one trip.', 'author' => 'Duc Minh'],
                    ...
                    'highlights' => [
                        'Old city temples & Doi Suthep viewpoint',
                        'Chiang Mai night market & Thai cooking class',
                        'Grand Palace, Wat Pho & Chao Phraya cruise',
                        'Phuket bay / Phi Phi island day trip',
                    ],
                    'itinerary' => [
                        ['day' => 1, 'title' => 'Chiang Mai — Welcome to Lanna', 'meals' => 'Dinner', 'transport' => ['plane', 'car'], 'overnight' => 'Chiang Mai', 'content' => 'CNX pickup, hotel check-in, old city stroll and night market.'],
                        ['day' => 2, 'title' => 'Chiang Mai — Temples & hills', 'meals' => 'Breakfast; Lunch', 'transport' => ['car'], 'overnight' => 'Chiang Mai', 'content' => 'Wat Phra Singh, Wat Chedi Luang; afternoon at Doi Suthep.'],
                        ['day' => 3, 'title' => 'Chiang Mai — Food & crafts', 'meals' => 'Breakfast; Lunch', 'transport' => ['car'], 'overnight' => 'Chiang Mai', 'content' => 'Thai cooking class; optional craft village or light trek.'],
                        ['day' => 4, 'title' => 'Fly to Bangkok', 'meals' => 'Breakfast', 'transport' => ['plane', 'car'], 'overnight' => 'Bangkok', 'content' => 'Domestic flight CNX–BKK; free afternoon in the city.'],
                        ['day' => 5, 'title' => 'Bangkok — Palaces & temples', 'meals' => 'Breakfast; Lunch', 'transport' => ['car', 'boat'], 'overnight' => 'Bangkok', 'content' => 'Grand Palace, Wat Pho; long-tail boat on the khlongs.'],
                        ['day' => 6, 'title' => 'Ayutthaya day trip', 'meals' => 'Breakfast; Lunch', 'transport' => ['car'], 'overnight' => 'Bangkok', 'content' => 'UNESCO Ayutthaya ruins; evening free in Bangkok.'],
                        ['day' => 7, 'title' => 'Fly to Phuket', 'meals' => 'Breakfast', 'transport' => ['plane', 'car'], 'overnight' => 'Phuket', 'content' => 'Flight BKK–HKT, beach resort check-in.'],
                        ['day' => 8, 'title' => 'Phi Phi / Phang Nga bay', 'meals' => 'Breakfast; Lunch', 'transport' => ['boat'], 'overnight' => 'Phuket', 'content' => 'Island day trip with snorkeling (route by season).'],
                        ['day' => 9, 'title' => 'Phuket — Free day', 'meals' => 'Breakfast', 'transport' => ['walking'], 'overnight' => 'Phuket', 'content' => 'Resort time, spa or Phuket Old Town by night.'],
                        ['day' => 10, 'title' => 'Farewell Thailand', 'meals' => 'Breakfast', 'transport' => ['car', 'plane'], 'overnight' => null, 'content' => 'Transfer to HKT for your international flight.'],
                    ],
                    'inclusions' => [
                        '4* hotels in Chiang Mai, Bangkok and Phuket',
                        'Domestic flights CNX–BKK and BKK–HKT',
                        'Private transfers / guides on touring days',
                        'One southern island day trip',
                        'Meals as listed in the itinerary',
                    ],
                    'exclusions' => [
                        'International flights into Chiang Mai / out of Phuket',
                    ...
                    'notes' => [
                        ...
                        'Best southern sea season: November–April.',
                    ],
                    'faqs' => [
                        ['q' => 'Can we swap Phuket for Krabi?', 'a' => 'Yes — tell us when booking and we will adjust flights and hotels within 24 hours.'],
                        ['q' => 'Are island tours safe for children?', 'a' => 'Yes — we choose age-appropriate boats with life jackets and onboard guides.'],
                    ],
                ],
            ],
        ]);
    ...
    public static function tourCategories(): array
    {
        return [
            ...
            [
                ...
                'faqs' => [],
                'packageSlugs' => ['bali-7-ngay-ubud-bien'],
            ],
            [
                'countrySlug' => 'bali',
                'slug' => 'bali-10-ngay',
            ...
            [
                ...
                'minDays' => 9,
                'maxDays' => 14,
                'packageSlugs' => ['thai-lan-10-ngay-bac-trung-nam'],
