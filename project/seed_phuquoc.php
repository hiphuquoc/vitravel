...
$__phuquocSeed = array(
    ...
    'tour_categories' => array(
        array('zoneSlug' => 'duong-dong', 'slug' => 'nua-ngay', 'type' => 'duration', 'sort' => 0, 'minDays' => 0, 'maxDays' => 1,
            ...
            'seoIntro' => array('vi' => 'Các tour nửa ngày ở Phú Quốc phù hợp ghép thêm trước hoặc sau chuyến đi chính.', 'en' => 'Half-day Phu Quoc tours are easy to add before or after your main trip.'),
            'faqs' => array()),
        array('zoneSlug' => 'duong-dong', 'slug' => '1-ngay', 'type' => 'duration', 'sort' => 1, 'minDays' => 1, 'maxDays' => 1,
            ...
            'description' => array('vi' => 'VinWonders, Hòn Thơm, 4 đảo, Bãi Sao hoặc safari — không cần ngủ đêm thêm.', 'en' => 'VinWonders, Hon Thom, 4 islands, Bai Sao or safari — no extra overnight needed.'),
        ...
        array('zoneSlug' => 'duong-dong', 'slug' => '2-3-ngay', 'type' => 'duration', 'sort' => 2, 'minDays' => 2, 'maxDays' => 3,
            ...
            'description' => array('vi' => 'Kết hợp biển, công viên giải trí hoặc nghỉ yên trên đảo.', 'en' => 'Combine beach, theme parks or a quiet island stay.'),
            'seoIntro' => array('vi' => 'Tour 2–3 ngày cho phép cảm nhận trọn nhịp của đảo ngọc.', 'en' => 'A 2–3 day tour lets you feel Phu Quoc’s island rhythm.'),
            'faqs' => array()),
        array('zoneSlug' => 'duong-dong', 'slug' => '4-ngay-tro-len', 'type' => 'duration', 'sort' => 3, 'minDays' => 4, 'maxDays' => 10,
            ...
            'description' => array('vi' => 'Gói bay từ Sài Gòn với đủ điểm nhấn đảo.', 'en' => 'Flight packages from Saigon covering the island highlights.'),
            'seoIntro' => array('vi' => 'Tour dài ngày dành cho ai muốn chơi đủ biển và công viên trong một hành trình.', 'en' => 'Longer tours for travellers who want both beach and parks in one trip.'),
            'faqs' => array()),
        array('zoneSlug' => 'an-thoi-hon-thom', 'slug' => 'bien-nam-dao', 'type' => 'theme', 'sort' => 10,
            ...
            'description' => array('vi' => '4 đảo, cáp treo Hòn Thơm và thuyền lặn phía nam.', 'en' => '4 islands, Hon Thom cable car and south snorkel boats.'),
            'seoIntro' => array('vi' => 'Nam đảo là trái tim trải nghiệm biển của Phú Quốc.', 'en' => 'The south is the heart of Phu Quoc’s sea experiences.'),
            'faqs' => array()),
        array('zoneSlug' => 'vinpearl-grand-world', 'slug' => 'vui-choi-gia-dinh', 'type' => 'theme', 'sort' => 11,
            ...
            'description' => array('vi' => 'VinWonders, Safari và Grand World.', 'en' => 'VinWonders, Safari and Grand World.'),
            'seoIntro' => array('vi' => 'Điểm nhấn giải trí lớn nhất đảo cho gia đình và nhóm bạn.', 'en' => 'The island’s biggest entertainment highlights for families and friends.'),
            'faqs' => array()),
        array('zoneSlug' => 'bai-sao', 'slug' => 'bien-bai-sao', 'type' => 'theme', 'sort' => 12,
            ...
            'description' => array('vi' => 'Cát trắng và làng chài hải sản phía đông nam.', 'en' => 'White sand and the seafood fishing village on the southeast.'),
            'seoIntro' => array('vi' => 'Bãi Sao là điểm tắm được nhắc tới nhiều nhất trên đảo ngọc.', 'en' => 'Bai Sao is the most talked-about swim stop on the pearl island.'),
            'faqs' => array()),
        array('zoneSlug' => 'ket-hop-rach-gia', 'slug' => 'ket-hop-rach-gia', 'type' => 'package', 'sort' => 15, 'minDays' => 2, 'maxDays' => 4,
            ...
            'description' => array('vi' => 'Nối Rạch Giá / Hà Tiên hoặc bay từ Sài Gòn với đảo.', 'en' => 'Link Rach Gia / Ha Tien or Saigon flights with the island.'),
            'seoIntro' => array('vi' => 'Tour kết hợp giúp khách không phải tự lo nối xe–tàu–bay.', 'en' => 'Combined tours remove the stress of connecting road, ferry and flight yourself.'),
            'faqs' => array()),
    ),
