 ...
 * Hub (đứng đầu — themes gắn đây; dải resort chính):
 *   ham-tien-bai-bien — Nguyễn Đình Chiểu, kite school, resort sát bãi
 * GEO (search/book riêng):
 *   doi-cat-do — jeep sunrise, điểm chụp iconic
 *   doi-cat-trang-bau-trang — sa mạc mini ~30km, hồ Bàu Trắng
 *   suoi-tien — Fairy Stream, đi bộ barefoot
 *   lang-chai-mui-ne — thuyền đánh cá, nước mắm, hải sản
 *   phan-thiet-thanh-pho — tháp Chăm Po Sah Inu, cảng, KS thành phố
 *   ke-ga-ta-cu — hải đăng Ke Ga, núi Ta Cu phía nam
 * Combo only (ket-hop-* — KHÔNG gắn stay vật lý):
 *   ket-hop-da-lat — biển + cao nguyên (~3–4h đèo)
 *   ket-hop-nha-trang — Cam Ranh/Nha Trang (~2h)
 *   ket-hop-sai-gon — limo cuối tuần / tour ngày từ Sài Gòn
...
'en' => array('title' => 'Kite-surf & cuối tuần Sài Gòns', 'title_accent' => 'wind season Nov–Mar & limousine',
    ...
    // Zones → countries. Hub = ham-tien-bai-bien (dải resort/themes); GEO = dunes/town/Ke Ga; ket-hop-* = combo.
    // SEO country: parent_id=null; public URL /{slug}. Themes gắn hub ham-tien-bai-bien.
    'zones' => array(
...
$__servicesSeed = [
    ...
    'services' => [
        ['code' => 'train-limo-sgn-mn-oneway', 'cluster' => 'train', 'category_slug' => 'limousine-sgn-mui-ne', 'title' => 'Limousine Sài Gòn → Mũi Né (một chiều)', 'slug' => 'limousine-sai-gon-mui-ne-mot-chieu', 'price_from' => 280000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 1560, 'is_featured' => true, 'is_hot_deal' => true, 'discount_badge' => 'Đón tận nơi', 'location_label' => 'Sài Gòn → Mũi Né', 'summary' => '4–5 giờ, đón quận trung tâm — không tàu hoả.', 'highlights' => ['250–350k tham khảo', '9–16 chỗ', 'Weekend phổ biến'], 'inclusions' => ['Limousine một chiều'], 'exclusions' => ['Đón xa trung tâm'], 'notes' => ['Đặt trước T6–CN.'], 'attrs' => ['from' => 'SGN', 'to' => 'Mũi Né', 'duration_hours' => 4.5, 'vehicle_type' => 'limousine']],
        ['code' => 'train-limo-sgn-mn-round', 'cluster' => 'train', 'category_slug' => 'limousine-sgn-mui-ne', 'title' => 'Limousine khứ hồi Sài Gòn ↔ Mũi Né', 'slug' => 'limousine-khu-hoi-sai-gon-mui-ne', 'price_from' => 520000, 'currency' => 'VND', 'rating' => 4.9, 'review_count' => 980, 'is_featured' => true, 'location_label' => 'SGN ↔ Mũi Né', 'summary' => 'Cuối tuần 2 ngày 1 đêm — tiết kiệm hơn 2 chiều lẻ.', 'highlights' => ['Khứ hồi', 'Giữ chỗ chiều về'], 'inclusions' => ['2 chiều limousine'], 'exclusions' => [], 'notes' => [], 'attrs' => ['from' => 'SGN', 'to' => 'Mũi Né', 'vehicle_type' => 'limousine']],
        ['code' => 'train-bus-sgn-mn', 'cluster' => 'train', 'category_slug' => 'xe-khach-sgn-mui-ne', 'title' => 'Xe khách Sài Gòn → Mũi Né', 'slug' => 'xe-khach-sai-gon-mui-ne', 'price_from' => 150000, 'currency' => 'VND', 'rating' => 4.5, 'review_count' => 678, 'is_featured' => false, 'location_label' => 'Sài Gòn → Mũi Né', 'summary' => 'Giá rẻ — tự taxi ra resort.', 'highlights' => ['Open bus'], 'inclusions' => ['Vé một chiều'], 'exclusions' => ['Taxi resort'], 'notes' => [], 'attrs' => ['from' => 'SGN', 'to' => 'Mũi Né', 'duration_hours' => 5, 'vehicle_type' => 'xe khách']],
        ['code' => 'train-dl-mn', 'cluster' => 'train', 'category_slug' => 'xe-da-lat-mui-ne', 'title' => 'Xe Đà Lạt → Mũi Né', 'slug' => 'xe-da-lat-mui-ne', 'price_from' => 350000, 'currency' => 'VND', 'rating' => 4.6, 'review_count' => 234, 'is_featured' => true, 'location_label' => 'Đà Lạt → Mũi Né', 'summary' => 'Đèo 3–4 giờ — combo cao nguyên.', 'highlights' => ['Combo ĐL'], 'inclusions' => ['Vé hoặc xe riêng'], 'exclusions' => [], 'notes' => ['Đường đèo — nên ban ngày.'], 'attrs' => ['from' => 'Đà Lạt', 'to' => 'Mũi Né', 'duration_hours' => 3.5]],
        ['code' => 'train-nt-mn', 'cluster' => 'train', 'category_slug' => 'xe-nha-trang-mui-ne', 'title' => 'Xe Nha Trang → Mũi Né', 'slug' => 'xe-nha-trang-mui-ne', 'price_from' => 280000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 312, 'is_featured' => true, 'location_label' => 'Nha Trang → Mũi Né', 'summary' => '~2 giờ — sau bay Cam Ranh.', 'highlights' => ['Transfer CXR'], 'inclusions' => ['Xe 4–7 chỗ'], 'exclusions' => [], 'notes' => [], 'attrs' => ['from' => 'Nha Trang', 'to' => 'Mũi Né', 'duration_hours' => 2]],
        ['code' => 'train-charter-private', 'cluster' => 'train', 'category_slug' => 'xe-rieng-charter', 'title' => 'Xe riêng Sài Gòn — Mũi Né (4–16 chỗ)', 'slug' => 'xe-rieng-sai-gon-mui-ne', 'price_from' => 2800000, 'currency' => 'VND', 'rating' => 4.9, 'review_count' => 89, 'is_featured' => true, 'location_label' => 'Sài Gòn → Mũi Né', 'summary' => 'Lịch linh hoạt — đoàn resort.', 'highlights' => ['Private', 'Dừng chân tuỳ ý'], 'inclusions' => ['Xe + tài xế'], 'exclusions' => ['Cầu đường'], 'notes' => [], 'attrs' => ['vehicle_type' => '4–16 chỗ']],
        ['code' => 'train-resort-pickup', 'cluster' => 'train', 'category_slug' => 'xe-don-resort', 'title' => 'Xe đón bến xe / sân bay → resort', 'slug' => 'xe-don-resort-ham-tien', 'price_from' => 180000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 445, 'is_featured' => true, 'location_label' => '→ Ham Tien', 'summary' => 'Đón tận sảnh resort.', 'highlights' => ['Bảng tên'], 'inclusions' => ['Xe một chiều'], 'exclusions' => [], 'notes' => [], 'attrs' => ['service_type' => 'resort_transfer']],
        ['code' => 'flight-cxr-mn', 'cluster' => 'flight', 'category_slug' => 'bay-cxr-nha-trang', 'title' => 'Transfer Cam Ranh (CXR) → Mũi Né', 'slug' => 'transfer-cam-ranh-mui-ne', 'price_from' => 450000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 267, 'is_featured' => true, 'location_label' => 'CXR → Mũi Né', 'summary' => '~2h — theo dõi flight.', 'highlights' => ['Door-to-resort'], 'inclusions' => ['Xe 4–7 chỗ'], 'exclusions' => ['Vé bay'], 'notes' => ['Gửi số hiệu chuyến bay.'], 'attrs' => ['from' => 'CXR', 'to' => 'Mũi Né', 'duration_hours' => 2]],
        ['code' => 'flight-tbb-connect', 'cluster' => 'flight', 'category_slug' => 'bay-tbb-tuy-hoa', 'title' => 'Tư vấn Tuy Hòa (TBB) + xe Mũi Né', 'slug' => 'tu-van-tuy-hoa-mui-ne', 'price_from' => 0, 'currency' => 'VND', 'rating' => 4.6, 'review_count' => 45, 'is_featured' => false, 'location_label' => 'TBB → Mũi Né', 'summary' => 'TBB ~3–4h xe — tư vấn miễn phí.', 'highlights' => ['Tư vấn'], 'inclusions' => ['Tư vấn'], 'exclusions' => ['Vé bay', 'Xe'], 'notes' => [], 'attrs' => ['price_label' => 'Liên hệ']],
        ['code' => 'flight-airport-transfer', 'cluster' => 'flight', 'category_slug' => 'dua-don-san-bay', 'title' => 'Đưa đón SGN sân bay ↔ limo bến', 'slug' => 'dua-don-sgn-san-bay', 'price_from' => 280000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 156, 'is_featured' => true, 'location_label' => 'SGN airport', 'summary' => 'Xe riêng đón sảnh bay.', 'highlights' => ['Theo dõi flight'], 'inclusions' => ['Xe 4 chỗ'], 'exclusions' => ['Limo Mũi Né'], 'notes' => [], 'attrs' => ['from' => 'SGN', 'duration_hours' => 0.5]],
        ['code' => 'flight-combo-cxr', 'cluster' => 'flight', 'category_slug' => 'combo-bay-xe-mui-ne', 'title' => 'Combo bay Cam Ranh + transfer + resort 2 ngày 1 đêm', 'slug' => 'combo-bay-cxr-mui-ne-resort', 'price_from' => 4200000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 78, 'is_featured' => true, 'is_hot_deal' => true, 'location_label' => 'CXR → Mũi Né', 'summary' => 'Một báo giá bay + xe + resort.', 'highlights' => ['Một đầu mối'], 'inclusions' => ['Vé bay', 'Transfer', 'Resort 1 đêm'], 'exclusions' => ['Jeep'], 'notes' => ['Giá theo ngày bay.'], 'attrs' => ['price_label' => 'Từ']],
        ['code' => 'flight-sgn-advice', 'cluster' => 'flight', 'category_slug' => 'bay-sgn-ket-noi', 'title' => 'Tư vấn vé bay Sài Gòn + limo Mũi Né', 'slug' => 'tu-van-ve-bay-sgn-mui-ne', 'price_from' => 0, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 67, 'is_featured' => true, 'location_label' => 'Sài Gòn → Mũi Né', 'summary' => 'Ghép vé bay + limousine.', 'highlights' => ['Miễn phí tư vấn'], 'inclusions' => ['Tư vấn'], 'exclusions' => ['Vé', 'Xe'], 'notes' => [], 'attrs' => ['price_label' => 'Liên hệ']],
