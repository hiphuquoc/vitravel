...
$__servicesSeed = [
    ...
    'services' => [
        ...
        ['code' => 'train-charter-hn-td', 'cluster' => 'train', 'category_slug' => 'xe-rieng-charter', 'zone_slug' => 'ket-hop-ha-noi', 'title' => 'Xe riêng Hà Nội — Tam Đảo (4–16 chỗ)', 'slug' => 'xe-rieng-ha-noi-tam-dao', 'price_from' => 2200000, 'currency' => 'VND', 'rating' => 4.9, 'review_count' => 67, 'is_featured' => true, 'location_label' => 'Hà Nội → Tam Đảo', 'summary' => 'Lịch linh hoạt — dừng chân đèo tự do.', 'highlights' => ['Private', 'MICE'], 'inclusions' => ['Xe + tài xế'], 'exclusions' => ['Cầu đường'], 'notes' => [], 'attrs' => ['vehicle_type' => '4–16 chỗ']],
        ...
        ['code' => 'flight-han-td-transfer', 'cluster' => 'flight', 'category_slug' => 'noi-bai-transfer', 'zone_slug' => 'ket-hop-ha-noi', 'title' => 'Transfer Nội Bài (Hà Nội) → Tam Đảo', 'slug' => 'transfer-noi-bai-tam-dao', 'price_from' => 650000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 234, 'is_featured' => true, 'location_label' => 'Hà Nội → Tam Đảo', 'summary' => 'Bay Hà Nội + xe ~2.5–3h lên đồi — theo dõi flight.', 'highlights' => ['Door-to-resort'], 'inclusions' => ['Xe 4–7 chỗ'], 'exclusions' => ['Vé bay'], 'notes' => ['Gửi số hiệu chuyến bay.'], 'attrs' => ['from' => 'HAN', 'to' => 'Tam Đảo', 'duration_hours' => 3]],
        ['code' => 'flight-han-door', 'cluster' => 'flight', 'category_slug' => 'dua-don-noi-bai', 'zone_slug' => 'ket-hop-ha-noi', 'title' => 'Đưa đón Nội Bài ↔ Hà Nội nội thành', 'slug' => 'dua-don-noi-bai-ha-noi', 'price_from' => 280000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 189, 'is_featured' => true, 'location_label' => 'Hà Nội ↔ Hà Nội', 'summary' => 'Xe riêng sảnh bay — ghép limo Tam Đảo.', 'highlights' => ['Theo dõi flight'], 'inclusions' => ['Xe 4 chỗ'], 'exclusions' => ['Lên Tam Đảo'], 'notes' => [], 'attrs' => ['from' => 'HAN', 'duration_hours' => 0.75]],
        ['code' => 'flight-combo-han-td', 'cluster' => 'flight', 'category_slug' => 'combo-bay-transfer-tam-dao', 'zone_slug' => 'ket-hop-ha-noi', 'title' => 'Combo vé bay Hà Nội + transfer Tam Đảo', 'slug' => 'combo-ve-bay-han-transfer-tam-dao', 'price_from' => 1350000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 78, 'is_featured' => true, 'is_hot_deal' => true, 'location_label' => 'Hà Nội → Tam Đảo', 'summary' => 'Một báo giá bay + xe lên đồi.', 'highlights' => ['Một đầu mối'], 'inclusions' => ['Vé bay', 'Transfer'], 'exclusions' => ['Resort', 'Tour'], 'notes' => ['Giá theo ngày bay.'], 'attrs' => ['from' => 'HAN', 'to' => 'Tam Đảo']],
