 ...
 *   thi-tran-sapa — nhà thờ đá, chợ đêm, Ham Rong, phố núi
 * GEO (search/book riêng):
 *   fansipan-sun-world — cáp treo, tàu Mười Mây, đỉnh 3143m
 *   thung-lung-muong-hoa — ruộng bậc thang UNESCO, tàu leo núi
 *   ban-cat-cat-y-linh-ho — làng H'Mông, thác Cát Cát
 *   thac-bac-thac-tinh-yeu — thác giữa rừng thông
 *   homestay-trek-ban-ho — trek Lao Chai—Ta Van, ngủ nhà dân
 *   lao-cai-cua-ngo — ga tàu, shuttle 38km lên Sa Pa
 * Combo only (ket-hop-* — KHÔNG gắn stay vật lý):
 *   ket-hop-bac-ha — chợ phiên Chủ nhật Flower H'Mông
 *   ket-hop-ha-noi — tàu đêm / limo từ Hà Nội
 *   ket-hop-mu-cang-chai — Sa Pa + bậc thang vàng Tây Bắc
...
'en' => array('title' => 'Cuối tuần from Hanoi', 'title_accent' => 'overnight SP/CH train & 5–6h limo',
    ...
    // Zones → countries. Hub đầu; GEO = Fansipan/Mường Hoa/bản/thác/homestay/Lào Cai; ket-hop-* = combo.
    // SEO country: parent_id=null; public URL /{slug}. Themes gắn hub thi-tran-sapa.
    'zones' => array(
...
$__servicesSeed = [
    ...
    'services' => [
        ['code' => 'train-sp-hn-lc', 'cluster' => 'train', 'category_slug' => 'tau-dem-ha-noi-lao-cai', 'title' => 'Tàu đêm SP Hà Nội → Lào Cai (cabin 4 người)', 'slug' => 'tau-dem-sp-ha-noi-lao-cai', 'price_from' => 850000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 1560, 'is_featured' => true, 'is_hot_deal' => true, 'location_label' => 'Hà Nội → Lào Cai', 'summary' => '~8h, tối T6 phổ biến — cabin 4 người.', 'highlights' => ['Tàu SP nhanh', 'Cabin 4/6', 'Cuối tuần đông khách'], 'inclusions' => ['Vé tàu một chiều'], 'exclusions' => ['Shuttle Sa Pa'], 'notes' => ['Đặt trước T6–CN.'], 'attrs' => ['from' => 'Hà Nội', 'to' => 'Lào Cai', 'duration_hours' => 8, 'vehicle_type' => 'tàu SP']],
        ['code' => 'train-ch-hn-lc', 'cluster' => 'train', 'category_slug' => 'tau-dem-ha-noi-lao-cai', 'title' => 'Tàu đêm CH Hà Nội → Lào Cai (giá rẻ)', 'slug' => 'tau-dem-ch-ha-noi-lao-cai', 'price_from' => 550000, 'currency' => 'VND', 'rating' => 4.6, 'review_count' => 890, 'is_featured' => true, 'location_label' => 'Hà Nội → Lào Cai', 'summary' => '~9h — tiết kiệm hơn SP.', 'highlights' => ['Giá rẻ', 'Cabin 6'], 'inclusions' => ['Vé tàu một chiều'], 'exclusions' => ['Shuttle Sa Pa'], 'notes' => [], 'attrs' => ['from' => 'Hà Nội', 'to' => 'Lào Cai', 'duration_hours' => 9, 'vehicle_type' => 'tàu CH']],
        ['code' => 'train-sp-round', 'cluster' => 'train', 'category_slug' => 'tau-dem-ha-noi-lao-cai', 'title' => 'Tàu đêm khứ hồi Hà Nội ↔ Lào Cai (SP)', 'slug' => 'tau-dem-khu-hoi-sp-ha-noi-lao-cai', 'price_from' => 1600000, 'currency' => 'VND', 'rating' => 4.9, 'review_count' => 720, 'is_featured' => true, 'location_label' => 'Hà Nội ↔ Lào Cai', 'summary' => 'Cuối tuần 2 ngày 1 đêm — tiết kiệm hơn 2 chiều lẻ.', 'highlights' => ['Khứ hồi SP', 'Giữ chỗ CN về'], 'inclusions' => ['2 chiều tàu SP'], 'exclusions' => ['Shuttle'], 'notes' => [], 'attrs' => ['from' => 'Hà Nội', 'to' => 'Lào Cai', 'vehicle_type' => 'tàu SP']],
        ['code' => 'train-limo-hn-sp', 'cluster' => 'train', 'category_slug' => 'limousine-ha-noi-sapa', 'title' => 'Limousine Hà Nội → Sa Pa (một chiều)', 'slug' => 'limousine-ha-noi-sapa-mot-chieu', 'price_from' => 320000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 1120, 'is_featured' => true, 'location_label' => 'Hà Nội → Sa Pa', 'summary' => '5–6 giờ thẳng lên Sa Pa.', 'highlights' => ['9–16 chỗ', 'Không qua tàu'], 'inclusions' => ['Limousine một chiều'], 'exclusions' => ['Đón xa trung tâm'], 'notes' => [], 'attrs' => ['from' => 'Hà Nội', 'to' => 'Sa Pa', 'duration_hours' => 5.5, 'vehicle_type' => 'limousine']],
        ['code' => 'train-bus-lc-sp', 'cluster' => 'train', 'category_slug' => 'xe-khach-lao-cai-sapa', 'title' => 'Shuttle Lào Cai → Sa Pa (sau tàu đêm)', 'slug' => 'shuttle-lao-cai-sapa', 'price_from' => 80000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 2340, 'is_featured' => true, 'location_label' => 'Lào Cai → Sa Pa', 'summary' => '38km đèo — đón ga 6h–7h sáng.', 'highlights' => ['Ghép sau tàu', 'Bảng tên'], 'inclusions' => ['Xe một chiều'], 'exclusions' => [], 'notes' => ['Sương mù có thể trễ 30–60 phút.'], 'attrs' => ['from' => 'Lào Cai', 'to' => 'Sa Pa', 'duration_hours' => 1, 'vehicle_type' => 'shuttle']],
        ['code' => 'train-bac-ha', 'cluster' => 'train', 'category_slug' => 'ket-noi-bac-ha', 'title' => 'Xe Sa Pa ↔ Bắc Hà (chợ Chủ nhật)', 'slug' => 'xe-sapa-bac-ha-cho-phien', 'price_from' => 280000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 156, 'is_featured' => true, 'location_label' => 'Sa Pa ↔ Bắc Hà', 'summary' => '~2h — combo chợ phiên.', 'highlights' => ['Chủ nhật', 'Combo tour'], 'inclusions' => ['Xe khứ hồi'], 'exclusions' => ['HDV'], 'notes' => ['Chỉ Chủ nhật.'], 'attrs' => ['from' => 'Sa Pa', 'to' => 'Bắc Hà', 'duration_hours' => 2]],
        ['code' => 'train-charter-hn-sp', 'cluster' => 'train', 'category_slug' => 'xe-rieng-charter', 'title' => 'Xe riêng Hà Nội — Sa Pa (4–16 chỗ)', 'slug' => 'xe-rieng-ha-noi-sapa', 'price_from' => 3500000, 'currency' => 'VND', 'rating' => 4.9, 'review_count' => 89, 'is_featured' => true, 'location_label' => 'Hà Nội → Sa Pa', 'summary' => 'Lịch linh hoạt — dừng chân đèo tự do.', 'highlights' => ['Xe riêng', 'Gia đình'], 'inclusions' => ['Xe + tài xế'], 'exclusions' => ['Cầu đường'], 'notes' => [], 'attrs' => ['vehicle_type' => '4–16 chỗ']],
        ['code' => 'train-pickup-ga', 'cluster' => 'train', 'category_slug' => 'xe-don-ga-lao-cai', 'title' => 'Đón ga Lào Cai + shuttle Sa Pa', 'slug' => 'don-ga-lao-cai-shuttle-sapa', 'price_from' => 150000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 890, 'is_featured' => true, 'location_label' => 'Ga → Sa Pa', 'summary' => 'Combo đón tàu + lên thị trấn.', 'highlights' => ['Bảng tên', 'Ghép tàu SP/CH'], 'inclusions' => ['Đón ga', 'Shuttle'], 'exclusions' => [], 'notes' => [], 'attrs' => ['service_type' => 'station_pickup']],
        ['code' => 'flight-han-sp-transfer', 'cluster' => 'flight', 'category_slug' => 'noi-bai-transfer', 'title' => 'Transfer Nội Bài (Hà Nội) → Sa Pa', 'slug' => 'transfer-noi-bai-sapa', 'price_from' => 850000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 312, 'is_featured' => true, 'location_label' => 'Hà Nội → Sa Pa', 'summary' => 'Bay Hà Nội + xe ~5–6h lên Sa Pa — theo dõi flight.', 'highlights' => ['Door-to-hotel'], 'inclusions' => ['Xe 4–7 chỗ'], 'exclusions' => ['Vé bay'], 'notes' => ['Gửi số hiệu chuyến bay.'], 'attrs' => ['from' => 'HAN', 'to' => 'Sa Pa', 'duration_hours' => 6]],
        ['code' => 'flight-han-door', 'cluster' => 'flight', 'category_slug' => 'dua-don-noi-bai', 'title' => 'Đưa đón Nội Bài ↔ Hà Nội nội thành', 'slug' => 'dua-don-noi-bai-ha-noi', 'price_from' => 280000, 'currency' => 'VND', 'rating' => 4.7, 'review_count' => 234, 'is_featured' => true, 'location_label' => 'Hà Nội ↔ Hà Nội', 'summary' => 'Xe riêng sảnh bay — ghép tàu/limo Sa Pa.', 'highlights' => ['Theo dõi flight'], 'inclusions' => ['Xe 4 chỗ'], 'exclusions' => ['Lên Sa Pa'], 'notes' => [], 'attrs' => ['from' => 'HAN', 'duration_hours' => 0.75]],
        ['code' => 'flight-combo-han-sp', 'cluster' => 'flight', 'category_slug' => 'combo-bay-tau-sapa', 'title' => 'Combo vé bay Hà Nội + transfer Sa Pa', 'slug' => 'combo-ve-bay-han-transfer-sapa', 'price_from' => 1450000, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 98, 'is_featured' => true, 'is_hot_deal' => true, 'location_label' => 'Hà Nội → Sa Pa', 'summary' => 'Một báo giá bay + xe lên núi.', 'highlights' => ['Một đầu mối'], 'inclusions' => ['Vé bay', 'Transfer'], 'exclusions' => ['Homestay', 'Tour'], 'notes' => ['Giá theo ngày bay.'], 'attrs' => ['from' => 'HAN', 'to' => 'Sa Pa']],
        ['code' => 'flight-han-advice', 'cluster' => 'flight', 'category_slug' => 'combo-bay-tau-sapa', 'title' => 'Tư vấn bay quốc tế HAN + Sa Pa', 'slug' => 'tu-van-bay-quoc-te-han-sapa', 'price_from' => 0, 'currency' => 'VND', 'rating' => 4.8, 'review_count' => 56, 'is_featured' => false, 'location_label' => 'Intl → Sa Pa', 'summary' => 'Khách bay Hà Nội — ghép transfer & tour.', 'highlights' => ['Miễn phí tư vấn'], 'inclusions' => ['Tư vấn'], 'exclusions' => ['Vé', 'Xe'], 'notes' => [], 'attrs' => ['price_label' => 'Liên hệ']],
