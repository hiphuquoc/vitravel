@php
    ...
    if ($rows === null) {
        $rows = ($data ?? collect())->map(fn ($row) => [
            'id' => $row->id,
            'review_platform_id' => $row->review_platform_id,
...
<div class="adminFormSection adminFormSection--repeater repeater" data-repeater-container>
    <div class="adminFormSection_header">
        <div class="adminFormSection_header_info">
            <h2 class="adminFormSection_title">Nền tảng đánh giá trên trang chủ</h2>
            <p class="adminFormSection_description">Chọn nền tảng đã cấu hình. Nội dung chi tiết (điểm, quote, URL) chỉnh trong mục Nền tảng đánh giá.</p>
        </div>
    ...
    <div class="adminFormSection_body">
        <div data-repeater-list="featured_platforms">
                ...
                <div class="adminFormRepeater_item adminFormRepeater_item--block" data-repeater-item>
                    ...
                    <div class="adminFormRepeater_item_content">
                        ...
                        @include('admin.components.formField', [
                            'label' => 'Nền tảng',
                            'name' => 'review_platform_id',
                            'type' => 'select',
                            'value' => $row['review_platform_id'] ?? '',
                            'options' => ['' => '— Chọn nền tảng —'] + $platformOptions,
